.. uCore-Tutorial-Guide-2023S documentation master file, created by
   sphinx-quickstart on Thu Oct 29 22:25:54 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

uCore-Tutorial-Guide 2023 Spring
==================================================
...
欢迎来到 uCore-Tutorial-Guide 2023 Spring!

指导书简介
----------------------------

该指导书为 `THU` `OS` 课程实验 `C` 版实验指导书，旨在帮助同学们快速熟悉框架并完成书面和编程任务, `配套代码 <https://github.com/learningos/ucore-Tutorial-Code-2023S>`_ 。
...
- `该文档仓库文档仓库 <https://github.com/learningos/ucore-Tutorial-Guide-2023A>`_
